...
export function TaskDetailsMarkdown({ task }: TaskDetailsMarkdownProps) {
    ...
    function onSave() {
        ...
        const newTask = {
            ...task,
            desc: markdown,
            badges: { ...task.badges, description: isDesc },
        }
        editTask(newTask)
        setIsEditing(false)
    }
        ...
        <section className="task-details-markdown">
            <header className="markdown-header">
                <TaskDetailsSectionHeader
                    title="Description"
                    icon="/img/taskBadges/description.svg"
                />
                {!isEditing && !isEmpty && (
                    <button
            ...
            <main className="markdown-body" ref={sectionRef}>
                ...
                {!isEditing && !isEmpty && (
                    <article
                        className="markdown-content-wraper"
                        onClick={() => setIsEditing(true)}
                    >
                ...
                {isEditing && (
                    <footer className="markdown-footer">
                        ...
                        <article className="markdown-footer-links">
                            <a
                                className="btn btn-primary"
                                href="https://support.atlassian.com/trello/docs/how-to-format-your-text-in-trello/"
                                target="_blank"
                            >
                                Formatting help
                            </a>
